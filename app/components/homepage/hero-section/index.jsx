...
<h1 className="text-3xl font-bold leading-10 text-white md:font-extrabold lg:text-[2.6rem] lg:leading-[3.5rem]">
  ...
  <span className="text-white typewriter-effect" style="animation-delay: 4s">
    This is <span className="text-pink-500">{personalData.name},</span><br />
  </span>
  <span className="text-white typewriter-effect" style="animation-delay: 8s">
    I'm a Professional <br />
  </span>
  <span className="text-[#16f2b3] typewriter-effect" style="animation-delay: 12s">
