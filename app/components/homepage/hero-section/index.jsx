          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div className="ml-4 lg:ml-8 mr-2">
                ...
                <span className="text-gray-400">[</span>
                {[
                  'React', 'NextJS', 'Flarum', 'Python', 'NestJS', 'MySql',
                  'MongoDB', 'Docker', 'AWS', 'Tailwind', 'TypeScript',
              ...
              <div>
                <span className="ml-8 lg:ml-16 text-orange-400">return</span> <span className="text-gray-400">(</span>
              </div>
              ...
              <div className="ml-12 lg:ml-24">
                <span className="text-cyan-400">this.</span><span className="text-white">skills.length</span> <span className="text-amber-300">&gt;=</span> <span className="text-orange-400">5</span>
              </div>
