  ...
  <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
    <code className="font-mono text-xs md:text-sm lg:text-base block">
      ...
      <div>
        ...
        <span className="text-gray-400">'</span>
        <span className="text-amber-300">Dev Zahir</span>
        <span className="text-gray-400">',</span>
      </div>
      <div className="ml-4 lg:ml-8 mr-2">
        <span className="text-white">skills:</span>
        <span className="text-gray-400">[</span>
        <span className="text-amber-300">'HTML'</span><span className="text-gray-400">, </span>
        <span className="text-amber-300">'CSS'</span><span className="text-gray-400">, </span>
        ...
        <span className="text-amber-300">'Git'</span><span className="text-gray-400">, </span>
        <span className="text-amber-300">'Python'</span><span className="text-gray-400">, </span>
        <span className="text-amber-300">'WordPress'</span><span className="text-gray-400">, </span>
        <span className="text-amber-300">'Markdown'</span><span className="text-gray-400">, </span>
        <span className="text-amber-300">'Django'</span><span className="text-gray-400">, </span>
